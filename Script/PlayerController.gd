...
const TOJOK_DEFAULT_POSITION = Vector3(0.235, -0.275, -0.7)
const TOJOK_DEFAULT_ROTATION = Vector3(37.5, -63.5, -57.0)
const TOJOK_SHOOT_POSITION = Vector3(0.155, -0.35, -0.8)
const TOJOK_SHOOT_ROTATION = Vector3(37.5, -63.5, -57.0)
